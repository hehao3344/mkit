...
/* 相对STM8S103有所调整 按键PB7=>PB3 开关继电器PB6=>PB2 */
...
//#define  PA_TXD_OUT()            
//#define  PA_RXD_OUT()   
#define KEY_STATUS      GPIO_ReadInputPin(GPIOB, GPIO_PIN_3)

// 低电平亮 高电平灭
#define STATUS_ON       GPIO_WriteLow(GPIOD, GPIO_PIN_0)
#define STATUS_OFF      GPIO_WriteHigh(GPIOD, GPIO_PIN_0)

#define SWITCH_ON       GPIO_WriteHigh(GPIOB, GPIO_PIN_2)
#define SWITCH_OFF      GPIO_WriteLow(GPIOB, GPIO_PIN_2)
